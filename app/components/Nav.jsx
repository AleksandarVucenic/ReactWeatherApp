...
var Nav = React.createClass({
  onSearch: function (e) {
    ...
    if (location.length > 0) {
      ...
      window.location.hash = '#/?location=' + endodedLocation;
    }
  },
  render: function () {
    return (
      <div className="top-bar">
        ...
        <div className="top-bar-right">
          <form onSubmit={this.onSearch}>
            <ul className="menu">
              <li>
                <input type="search" placeholder="Search weather" placeholder="Searc wather by city" ref="search"/>
              </li>
              <li>
                <input type="submit" className="button" value="Get Weeather"/>
              </li>
            </ul>
          </form>
        </div>
